    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea name="detail" class="form-control" style="height: 150px;"
                 placeholder="Detalle del producto">{{ $product->detail }}</textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <button type="submit" class="btn btn-primary"><i class="bi bi-edit"></i> Guardar</button>
        </div>
    </div>
</form>
@endsection
